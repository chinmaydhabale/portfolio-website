        ...
        <div className='relative'>
            <div className='flex flex-col md:flex-row md:w-[80%] lg:w-[70%] mx-auto items-center gap-4 lg:gap-8 pt-4 md:pt-10 px-4'>
                ...
                <div className='md:w-[50%]'>
                    ...
                    <div className='flex border border-white px-4 py-1 items-center gap-2'>
            ...
            <div className='relative border border-white w-[90%] md:w-[55%] lg:w-[40%] mx-auto md:p-6 p-4 mt-10 text-center'>
